    ...
    return (
      <div className='cyphers'>
        <div className='cypher'>
          ...
          <button className={'btn cypher__btn ' + (this.props.cryptionType === OTP ? 'cypher__btn--selected' : null)}
        ...
        <div className='cypher'>
          ...
          <button className={'btn cypher__btn ' + (this.props.cryptionType === SHA2 ? 'cypher__btn--selected' : null)}
        ...
        <div className='cypher'>
          ...
          <button className={'btn cypher__btn ' + (this.props.cryptionType === MD5 ? 'cypher__btn--selected' : null)}
